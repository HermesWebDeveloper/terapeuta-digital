...
import { format } from 'date-fns';
    ...
    function ConsultaEditar({ salvarDados, consulta }) {
        ...
        useEffect( () => {
            ...
            if (consulta && consulta.data && consulta.retorno) { // Verifica se as datas estão definidas
                setNome(consulta.nome || '');
                setData(format(new Date(consulta.data), 'yyyy-MM-dd'));
                setRetorno(format(new Date(consulta.retorno), 'yyyy-MM-dd'));
                setQp(consulta.qp || '');
                setHda(consulta.hda || '');
                setPrt(consulta.prt || '');
            }
